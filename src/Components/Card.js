      ...
      <Card style={{ width: "18rem" }}>
        ...
        <ListGroup className="list-group-flush">
          ...
          <ListGroupItem>
            <div className="icon-container">
              <a href="https://www.linkedin.com/in/gershwen-mcpherson/">
                <i class="fab fa-linkedin fa-2x"></i>
              </a>
              <a href="https://github.com/Gershwen">
        ...
        <Card.Body>
          <Card.Text>
            ...
            <a href="https://github.com/Gershwen/My-CV">
              https://github.com/Gershwen/My-CV
            </a>
            .
          </Card.Text>
        </Card.Body>
